        ...
        <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300 group">
            ...
            <div className="relative h-56 bg-gray-200 overflow-hidden">
                    ...
                    <>
                        ...
                        {property.images.length > 1 && (
                            <>
                                <button
                                    onClick={prevImage}
                                    className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white p-1.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
                                ...
                                <button
                                    onClick={nextImage}
                                    className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white p-1.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
                ...
                <div className="absolute top-3 left-3 flex gap-2">
                    {property.isNew && <Badge variant="new">Chegou hoje</Badge>}
                    <Badge variant="propertyType">{property.type}</Badge>
                </div>
